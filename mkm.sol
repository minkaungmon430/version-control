     ...
     modifier NotApprover{ 
       ...
       modifier OnlyDeveloper1{
        ...
        modifier AllApprovers{ 
              ...
              modifier NotApprover1{ 
         require(tx.origin != developer1);
         _;
         }
...
function requestForApproval(address developerAddress, string documentHash) NotApprover1  public {
 require(contState==contractState.Created && developers[developerAddress] == developerState.ReadyToSubmit);
  ...
  ApprovalRequested(developer1, " Signature awaited from 'all' or atleast by '2/3rd' of approvers to update Version 1.0 on IPFS ");
  numberOfUploads +=1;
